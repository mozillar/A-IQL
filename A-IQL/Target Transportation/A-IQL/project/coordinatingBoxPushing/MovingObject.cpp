...
#include <math.h>
using namespace std;
MovingObject::MovingObject(double formal_x_left,double formal_x_right,double formal_y_up,double formal_y_down):ini_x_left(formal_x_left),ini_x_right(formal_x_right),ini_y_up(formal_y_up),ini_y_down(formal_y_down)
{
	...
	SetSize((formal_x_right - formal_x_left)*(formal_y_down-formal_y_up));
	SetIsActive(true);
}
...
void MovingObject::SetPos(double formal_x_left,double formal_x_right,double formal_y_up,double formal_y_down)
{
	point[LEFT_UP].x = formal_x_left;
	point[LEFT_UP].y = formal_y_up;
	point[RIGHT_UP].x = formal_x_right;
...
bool MovingObject::GetIsActive()
{
	return is_active;
}
void MovingObject::SetIsActive(bool formal_is_active)
{
	is_active = formal_is_active;
}
double MovingObject::GetSize()
{
	return size;
}
void MovingObject::SetSize(double formal_size)
{
	size = formal_size;
}
